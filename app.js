...
const app =() => {    //Display song, player, outline, video, and sounds
...
option.addEventListener('click', function(){
    ...
    timeDisplay.textContent =  `${Math.floor(beginningDuration/60)}: ${Math.floor(beginningDuration%60)}`
...
play.addEventListener("click", () => {
    ...
    song.ontimeupdate =() =>{
        ...
        let progress = outlineLength - (currentTime/beginningDuration) *outlineLength;
